    ...
    <div class="wrapper">
        <div class="row big-row">
                    ...
                    <ul class="nav">
                        <c:forEach items="${cate}" var="cate">
                            ...
                            <li class="${activeClass}">
                                <a href="${cpath}/omain?category_seq=${cate.category_seq}" id="cat${cate.category_seq}" class="cats">
            ...
            <div class="main-panel col-lg-7">
                <div class="content">
                    <div class="voice_row voice_area">
                        <div class="col-lg-3 voice_icon" id="micButton">
                        <div class="circle">
					        <svg
					          version="1.0"
					        ...
					        >
					          ...
					          >
					            <path
					              d="M1385 5034 c-369 -53 -693 -218 -946 -482 -359 -373 -506 -886 -410
					          -1432 41 -235 89 -364 281 -760 225 -463 246 -557 195 -885 -30 -189 -107
					          -398 -210 -565 -48 -79 -59 -104 -62 -150 -5 -64 17 -109 66 -134 16 -9 337
					          -135 713 -282 641 -249 686 -265 736 -261 62 4 103 37 127 101 8 23 71 238
					          140 480 68 241 126 440 128 443 2 2 123 -15 268 -37 203 -32 278 -40 324 -34
					          143 16 267 90 345 206 72 108 101 258 64 331 -9 18 -55 71 -101 118 -63 65
					          -81 88 -71 96 7 5 54 34 103 63 151 89 165 110 165 251 l0 76 67 7 c37 4 86
					          15 108 25 132 58 206 205 171 340 -8 33 -90 209 -182 393 l-167 333 6 94 c11
					          181 -20 415 -78 588 -78 234 -203 433 -389 619 -228 228 -456 355 -776 431
					          -94 23 -129 26 -345 28 -132 2 -253 1 -270 -1z m482 -309 c473 -77 873 -424
					          1017 -883 44 -140 56 -237 56 -448 l0 -193 175 -353 c96 -194 175 -356 175
					          -360 0 -5 -59 -8 -130 -8 l-131 0 -42 -39 -42 -40 -3 -140 -4 -141 -156 -94
					          c-191 -115 -222 -145 -222 -216 0 -56 27 -94 159 -225 72 -71 131 -135 131
					          -142 0 -7 -17 -30 -37 -51 -65 -68 -71 -68 -452 -10 -218 33 -346 49 -365 44
					          -16 -4 -46 -24 -66 -44 -35 -36 -41 -55 -164 -487 -71 -247 -131 -453 -135
					          -458 -6 -6 -989 369 -1023 389 -4 2 13 46 37 97 166 351 225 759 151 1050 -33
					          131 -81 247 -197 478 -167 334 -239 524 -275 725 -25 137 -25 406 -1 527 105
					          522 516 927 1036 1021 105 19 392 20 508 1z"
					                      />
					                      <path
					                        d="M4460 2927 c-50 -26 -80 -75 -80 -130 0 -50 9 -66 93 -162 166 -190
					          265 -389 319 -638 31 -144 31 -388 -1 -534 -51 -244 -165 -466 -327 -643 -36
					          -39 -69 -82 -74 -96 -38 -99 34 -204 138 -204 62 0 92 20 178 118 373 427 504
					          1011 348 1554 -73 254 -204 482 -388 675 -81 86 -130 100 -206 60z"
					                      />
					                      <path
					                        d="M4029 2500 c-39 -20 -79 -86 -79 -128 0 -38 26 -84 84 -152 246 -285
					          241 -701 -11 -990 -87 -100 -93 -182 -19 -248 84 -74 171 -47 279 88 172 214
					          258 502 228 765 -21 182 -71 326 -165 470 -129 196 -215 249 -317 195z"
					                      />
					                      <path
					                        d="M3644 2090 c-71 -15 -114 -70 -114 -145 0 -42 7 -60 40 -109 32 -48
					          40 -67 40 -105 0 -27 -7 -57 -18 -72 -58 -87 -62 -96 -62 -139 0 -115 123
					          -188 218 -130 48 30 77 66 117 145 76 151 59 332 -44 472 -50 68 -111 97 -177
					          83z"
					            />
					          </g>
					        </svg>
                        ...
                        <div class="col-lg-9 voice_help">
                        	<span>음성주문 원하시면 왼쪽 버튼을 클릭해주세요.</span>
                        	<p>("띵"소리가 들린 후 음성인식이 시작됩니다)</p>
                        </div>
                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row">
                                            <c:forEach var="menu" items="${menuGroup}" varStatus="status">
                                                <div class="col-lg-4 col-md-6 col-sm-6 menu-box" onclick="openModal2('${menu.menu_seq}', '${menu.menu_name}', ${menu.menu_price})">
                                                    ...
                                                    <div class="row menu-name" style="font-size: 1.5rem;">
                                                        <div class="col-lg-12">${menu.menu_name}</div>
                                                    </div>
                                                    <div class="row menu-price" style="font-size: 1.5rem;">
            ...
            <div class="md-container cont03">
		        <div class="md-dg">
		            ...
		            <div class="md-body row">
		                <div class="col-lg-12 md_body_size">
		                    <div class="row">
		                        <div class="col-lg-6">
		                            <img class="md-menu-img" src="https://img.79plus.co.kr/megahp/manager/upload/menu/20220630182321_1656581001230__fv6UmKGjl.jpg" alt="the_image" style="width: 100%">
		                        </div>
		                        <div class="col-lg-6 check_menu_info">
		                            <div class="row">
		                                <div class="col-lg-12 check_menu">
		                                    <p>주문하신</p>
		                                    <p class="check_menu_name"></p>
		                                    <div class="check_menu_cnt"></div>
		                                    <p class="check_menu_check">드릴까요?</p>
		                                </div>
		                            </div>
		                        </div>
		                    </div>
		            ...
		            <div class="md-footer conf-recog row">
		                 <div class="col-lg-6 btn miss_order" style="background-color: #fff; color: #1c1c1b; font-size: 45px; box-shadow: 0px 0px 3px 0px rgba(0, 0, 0, 0.325); flex: 0 0 42%; margin-left: 65px;">주문취소</div>
                        <div class="col-lg-6 btn collect_order" style="background-color: #ffdc00; color: #1c1c1b; font-size: 45px; margin-left: 90px; flex: 0 0 38%;">주문확인</div>
		            </div>
		        </div>
		    </div>
            ...
            <div class="md-container cont02">
                <div class="md-dg">
                    ...
                    <div class="md-body row d-flex">
                        <div class="col-lg-12">
                            <div class="row justify-content-center">
                                <div class="col-5 box old_check_menu">
                                    <div class="row old_check_menu">
                                        <p class="orderguide" id="top_orderguide">주문에 어려움이 있으신가요?</p>
                                        ...
                                        <input type="button" class="btn btn-outline-danger btn-lg basic_option" value="기본옵션 선택" />
                                         <div class="increase">
	                                        <input type="button" onclick="decrease()" class="q_btn1" value="-"> 
	                                        	<span name="menu_cnt" id="spanTag">1</span>
                    ...
                    <div class="md-footer conf-recog row">
                        <div class="col-lg-6 btn"  id="cancel_o" style="background-color: #fff; color: #1c1c1b; font-size: 45px; box-shadow: 0px 0px 2px 0px rgba(0, 0, 0, 0.325); flex: 0 0 42%; margin-left: 65px;">취소하기</div>
                        <div class="col-lg-6 btn" id="orderButton" style="background-color: #ffdc00; color: #1c1c1b; font-size: 45px; margin-left: 90px; flex: 0 0 38%;">주문담기</div>
                    </div>
                </div>
            </div>
...
>
           ...
           function payModal() {
            ...
            function openModal2(menu_seq, menu_name, menu_price) {
                $(".voice_icon").css("z-index", 0);
                if ($(".cont03").hasClass("md-on")) {
                    $(".cont03").removeClass("md-on");
                }
                $(".cont02").toggleClass("md-on");
                console.log("선택메뉴 seq : ", menu_seq);
                
                selectedMenu.menu_name = menu_name;
                selectedMenu.menu_price = menu_price;
                    	...
                    	console.log("option 데이터", data)
                         ...
                         for (const option of data) {
                             ...
                             const optionDiv = '<div class="radio">' +
                                 ...
                                 '<label class="radio-wrapper"> <input type="radio" class="radio-input basic" name="od_size" value="' + option.op_size_s + '" /> <span class="radio-tile">' +
                             ...
                             const optionDiv3 =
                                 ...
                                 '<label class="radio-wrapper">' +
                                 '<input type="radio" class="radio-input basic" name="od_ice" value="' +
                                 option.op_ice +
                                 '" />' +
                                 '<span class="radio-tile">' +
                             ...
                             const optionDiv6 =
                                 ...
                                 '<label class="radio-wrapper"> <input type="radio" class="radio-input basic" name="od_shot" value="' +
                                 option.op_shot +
                                 '"  /> <span class="radio-tile">' +
                                 '<span class="radio-icon"> <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256">' +
                             ...
                             const optionDiv9 = '<div class="radio">' +
                                 ...
                                 '<label class="radio-wrapper"> <input type="radio" class="radio-input basic" name="od_cup" value="' +
                                 option.op_cup +
                                 '"  />' +
                             ...
                             const radioButtonsCount = $(".radio-group .radio").length;
								console.log("radio갯수",radioButtonsCount)
                             if (radioButtonsCount == 11) {
                                 $(".box").css({
                                     height: "650px",
                                     top: "40px"
                                 });
            ...
            // 메뉴 옵션창 닫기
            function cancel() {
                document.querySelector(".cont02").className = "md-container cont02";
            }
            ...
            document.querySelector("#cancel_o").addEventListener("click", cancel);
            // 주문하기 클릭 시 닫기
            ...
            $('#orderButton').on('click', () => {
            	$(".voice_icon").css("z-index", 0);
                let menuPrice = selectedMenu.menu_price; // 기본 가격
            ...
            function makeAjaxCall() {
        	  ...
        	  // AJAX 호출을 "ajaxCall"이라는 문서 이벤트에 첨부합니다.
        	  $(document).one('ajaxCall', makeAjaxCall);

        	  // 페이지가 로드될 때 사용자 정의 "ajaxCall" 이벤트를 트리거합니다.
        	  $(document).trigger('ajaxCall');

            $(document).ready(function() {
            	
            	 const micContainer = $('#micButton');
            	  
                 micContainer.on('click', () => {
                   ...
                   const circle = micContainer.find(".circle");
                   if (circle.hasClass("active")) {
                     circle.html(spinner); // Show the spinner
                   } else {
                     circle.html(svg); // Show the SVG
                   }
                 });
            ...
            function whatsYourPoison() {
                $.ajax({
                    url: "http://127.0.0.1:5000/listen",
                    success: function(rsps) {
                        console.log(rsps)
                        
                        	let micContainer = $('#micButton');
                        	let circle = micContainer.find(".circle");
                        	let svg = `<svg
         					          version="1.0"
         					          xmlns="http://www.w3.org/2000/svg"
         					          width="256.000000pt"
                            	...
                            	$(".voice_help").html("<span>음성주문 원하시면 왼쪽 버튼을 클릭해주세요.</span> <p>('띵'소리가 들린 후 음성인식이 시작됩니다)</p>");
                        
                        $.ajax({
                            url: "${cpath}/getVoiceOrder",
                            data: {
                                menu_name: rsps.m_name
                            },
                            success: function(resultMenu) {
                            	
                                if (resultMenu !== null && resultMenu !== undefined) {
                                    $(".check_menu_name").text(resultMenu.menu_name);
                                    $(".check_menu_cnt").text(rsps.menu_cnt + "잔");
                                ...
                                selectedMenu.menu_name = resultMenu.menu_name
                                selectedMenu.menu_price = resultMenu.menu_price
                                selectedMenu.menu_cnt = rsps.menu_cnt
                                
                        			$(".cont03").addClass("md-on");
                    ...
                    error: function(xhr, error) {
                    	...
                    	$(".voice_help").html("<span> 다시 말씀 해주세요 </span>");
            ...
            // 아니오 눌렀을때
            $(".miss_order").on("click", function() {
                $(".cont03").removeClass("md-on")
            });
            // 예 눌렀을때
            
            $(".collect_order").on("click", function() {
                voiceModal(selectedMenu.menu_name, selectedMenu.menu_price, selectedMenu.menu_cnt);
            });
			...
			$(".voice_icon").on("click", function() {
			    ...
			    if (!$(this).hasClass("voiceClicked")) {
			        ...
			        whatsYourPoison()
			            ...
			            $(".voice_help").html("<span>인식중입니다" + dots + "</span> <br> <p>예시) 시원한 아메리카노 한 잔</p>");
            ...
            function voiceModal(menu_name, menu_price, menu_cnt) {
                $.ajax({
                    url: '${cpath}/getVoiceOptions',
                    data: {
                    	menu_name: menu_name
                    },
                    success: function(data) {
                        ...
                        const quantitySpan = document.getElementById("spanTag");
                        quantitySpan.innerText = menu_cnt;
